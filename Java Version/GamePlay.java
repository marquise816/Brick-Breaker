...
public class GamePlay extends JPanel implements KeyListener, ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(play) {
			...
			A: for(int i = 0; i < map.map.length; i++) {// the first map is an object instance of MapGen and the second map is the constructor of it
		...
		repaint(); // this redraw the screen for updates
